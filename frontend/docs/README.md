# Documentación de Vaxav Frontend

Esta carpeta contiene la documentación de los componentes, composables y otras partes del frontend de Vaxav.
...
- [useUsers](./composables/useUsers.md)
- [useRoles](./composables/useRoles.md)
- [usePermissions](./composables/usePermissions.md)

## Stores

- [useAuthStore](./stores/useAuthStore.md)
- [useNotificationStore](./stores/useNotificationStore.md)
...
- [Estilo de código](./guides/code-style.md)
- [Estructura del proyecto](./guides/project-structure.md)
- [Convenciones de nomenclatura](./guides/naming-conventions.md)
