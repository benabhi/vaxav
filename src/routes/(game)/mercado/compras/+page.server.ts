/**
 * Las órdenes de compra que el piloto tiene puestas.
 *
...
export const load: PageServerLoad = async ({ locals }) => {
	...
	return { orders: buildOrdersView(db, locals.pilot, 'buy') };
};
...
export const actions: Actions = {
	 ...
	 *
	 * Es instantáneo, al revés que publicarla: acordar una compra lleva tiempo
	 * porque hay alguien del otro lado con quien arreglar, y retirarse de la mesa
	 * no necesita el permiso de nadie. La garantía vuelve al saldo.
	 */
