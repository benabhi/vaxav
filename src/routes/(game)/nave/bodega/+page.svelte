			...
			{#each bodega.lines as linea (linea.itemCode)}
				...
				>
					<div class="flex w-full flex-wrap items-baseline gap-x-3 gap-y-1">
						...
						<div class="grow"></div>
						<!--
							Las tres cifras van juntas: si la fila no entra, bajan las tres de
							una y no queda un número suelto en su propio renglón.
						-->
					...
					<!--
						La barra compara contra lo cargado y no contra el tope: con la bodega
						a medio llenar, todas serían igual de cortas y no se vería qué la
						está llenando.
					-->
