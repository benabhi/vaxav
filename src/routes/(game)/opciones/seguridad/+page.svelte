<!--
	...
	página, así que los tres campos vuelven vacíos solos y, al ser contraseñas, es
...
<svelte:head><title>Seguridad · Opciones · Vaxav</title></svelte:head>

<div class="flex flex-col items-start gap-1">
	<Eyebrow>Opciones</Eyebrow>
	<DisplayTitle>Seguridad</DisplayTitle>
</div>
