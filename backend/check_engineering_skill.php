...
// Obtener la habilidad de Ingeniería Básica
$skill = $pilot->skills()->where('name', 'Ingeniería Básica')->first();

if (!$skill) {
    echo "Habilidad 'Ingeniería Básica' no encontrada.\n";
    exit(1);
}
...
echo "Información de la habilidad 'Ingeniería Básica':\n";
echo "=================================================================\n";
